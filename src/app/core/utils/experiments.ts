...
export const experiments = [
  ...
  },
  {
    ...
    passport: null,
    description: 'Затухающий шлейф из частиц вслед за курсором.',
    status: 'soon',
  },
  {
    slug: 'cursor-blob',
    ...
    category: 'cursor',
    difficulty: 4,
    tech: ['SVG', 'path interpolation', 'requestAnimationFrame'],
    passport: null,
    description: 'Аморфная капля, деформирующаяся от скорости движения.',
    status: 'soon',
  },
  {
